...
2. Enter the Access Token, Phone Number ID, Business Account ID (WABA ID), Webhook Verify Token, and App Secret you got from Meta.
3. Save. Odoo stores these values in system parameters:
   ...
   - `skillbridge_whatsapp_cloud.business_account_id`
